...
const CytologyViewer: React.FC<CytologyViewerProps> = ({
    imageUrl,
    isEditMode,
    segments,
}) => {
            ...
            if (currentSegmentRef.current) {
                dispatch(
                    addNewSegmentToStack({
                        seg_type: currentSegmentRef.current,
                        points: contour,
                    })
                )
            }
    ...
    const handleChangeSegment = useCallback(
        (segmentId: string, contour: IPoint[]) => {
            if (segmentStackRef) {
                ...
                const editedSegment = (
                    currentSegments ? currentSegments.segments : []
                ...
                if (editedSegment) {
                    dispatch(
                        editPointSegment({
                            id,
                            segType: editedSegment.seg_type,
                            points: contour,
                        })
                    )
                }
