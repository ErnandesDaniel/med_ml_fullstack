...
export function SubscriptionModal({
    ...
    const renderWaitingStep = () => (
        <div className={styles.waitingContainer}>
            ...
            <Text>
                Пожалуйста, завершите оплату в открывшемся окне. Это окно
                закроется автоматически после успешной оплаты.
            </Text>
        </div>
    )
                ...
                {tariffPlans.map((plan) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Text>
                                {plan.price} руб / {durationInDays} дней
                            </Text>
                            <Text
                                type="secondary"
